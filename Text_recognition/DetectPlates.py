...
def detectPlatesInScene(imgOriginalScene):
    ...
    print ("\n" + str(len(listOfPossiblePlates)) + " possible text found"   )       # 13 with MCLRNF1 image
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            print ("possible Text " + str(i) + ", click on any image and press a key to continue . . .")

            cv2.imshow("4b", listOfPossiblePlates[i].imgPlate)
            cv2.waitKey(0)
        # end for

        print ("\n Text detection complete, click on any image and press a key to begin char recognition . . .\n")
        cv2.waitKey(0)
    # end if # show steps #########################################################################
